    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <?php if(auth()->user()->hasPermission('read_settings')): ?>
                    <li>
                        <a href="<?php echo e(route('ad.vip')); ?>">
                            <i class="fas fa-crown"></i>
                            <span key="t-dashboards">VIP</span>
                        </a>
                    </li>
                <?php endif; ?>
...
<!-- Left Sidebar End --><?php /**PATH D:\Personal\Freelancer\Asmar Market\public_html_downlaod\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>